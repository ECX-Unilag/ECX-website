...
const AboutECX = () => {
    ...
    return (
        ...
        <div className={aboutStyles.vector1}><Image src={"/about/vector1.svg"} alt={"vector"} width={100} height={100}/></div>
        ...
        <div className={aboutStyles.vector2}><Image src={"/about/vector2.svg"} alt={"vector"} width={100} height={100}/></div>
        </div>
        </div>
    )
}
